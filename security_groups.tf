#Create Security Groups for Load Balancers, only TCP 80 & 443 and outbound access
...
#Create SG for allowing TCP 8080 & 22 from your IP in us-east-1
resource "aws_security_group" "jenkins-sg" {
  ...
  ingress {
    description     = "Allow anyone on any port"
